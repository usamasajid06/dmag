    ...
    <section className="text-gray-600 body-font">
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1 className="title-font sm:text-5xl text-4xl mb-4 font-normal text-gray-900">
            GET IN TOUCH
          </h1>
          ...
          <h1 className="title-font sm:text-2xl text-xl flex mb-4 text-gray-900">
          ...
          <p className="mb-8 leading-relaxed text-gray-800">+971 50 530 6401</p>

          <h1 className="title-font sm:text-2xl text-xl flex mb-4 text-gray-900">
            <MdOutlineMail className="mr-4 text-4xl" /> EMAIL
          </h1>
          <p className="mb-8 leading-relaxed text-gray-800">info@dmag.ae</p>

          <h1 className="title-font sm:text-3xl text-2xl mb-4 text-gray-900">
            Follow Us
          </h1>
